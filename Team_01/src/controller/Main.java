...
/**
 * This class creates left panel, right panel and Menu and Project buttons
 * 
 * @author Chandan
 * @version 4.0
 */
public class Main extends JFrame {
    ...
    /**
     * Resizing the scroll panes for left panel and toolbar
     */
    public Main() {
    ...
    /**
     * Function to create menu bar with load,save, compile and translate buttons.
     */
